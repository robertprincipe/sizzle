  ...
  return (
    <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 mt-5">
      <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          <h1 className="block text-3xl font-bold text-dark sm:text-4xl lg:text-6xl lg:leading-tight dark:text-light">
            Start your journey with{" "}
            <span className="text-blue-600">Preline</span>
          </h1>
          <p className="mt-3 text-lg text-dark dark:text-[#c7cdce]">
          ...
          <div className="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
            <div className="py-5">
              <div className="flex space-x-1">
                <svg
                  className="h-4 w-4 text-dark dark:text-muted"
                  width="51"
                  height="51"
                  viewBox="0 0 51 51"
                  fill="none"
              ...
              <p className="mt-3 text-sm text-dark dark:text-muted">
                <span className="font-bold">4.6</span> /5 - from 12k reviews
              </p>

              <div className="mt-5">
                <svg
                  className="h-auto w-16 text-dark dark:text-light"
                  width="80"
                  height="27"
                  viewBox="0 0 80 27"
                  fill="none"
        ...
        <div className="relative ml-4">
          ...
          />
          <div className="absolute inset-0 -z-[1] bg-gradient-to-tr from-muted via-white/0 to-white/0 w-full h-full rounded-md mt-4 -mb-4 mr-4 -ml-4 lg:mt-6 lg:-mb-6 lg:mr-6 lg:-ml-6 dark:from-dark dark:via--dark/0 dark:to--dark/0"></div>
